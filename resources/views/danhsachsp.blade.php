            ...
            <div class="row">
                ...
                <div class="col" style="text-align: right; margin-right:10px" >
                    <i class="bi bi-person-fill" > 
                        <b style="color: royalblue"><a href="/trangthemsp">Thêm sản phẩm</a></b>
                    </i>
                </div>
                <table class="table table-bordered" style="background-color:pink;">
                    ...
                    @foreach ($sanpham as $sp )
                                <tr>
                                    ...
                                    <td>
                                        <a href="/update/{{ $sp->Masanpham }}" class="btn btn-danger">Update</a>
                                        <a href="/delete/{{ $sp->Masanpham }}" class="btn btn-danger">Delete</a>
                                    </td>
                                </tr>
                                @endforeach
                </table>      
